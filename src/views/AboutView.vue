      ...
      <div class="flex flex-wrap">
        ...
        <div class="w-full px-4 lg:w-1/2 mt-1">
          ...
          <p class="font-medium text-base text-secondary max-w-xl lg:text-lg">
            ...
            Please feel free to contact me through the social media profiles
            listed below. Let's collaborate, share ideas, and build beneficial
            relationships together! I'm looking forward to hearing from you
            soon.
          </p>
          <div class="flex items-center dark:text-white mt-3">
            ...
            <!-- {{-- Github --}} -->
            <a
              href="https://github.com/muhammadisa226"
              target="_blank"
              class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 hover:border-primary hover:bg-primary hover:text-white"
            >
              <svg
            ...
            <!-- {{-- Facebook --}} -->
            <a
              href="https://web.facebook.com/profile.php?id=100015422892911"
              target="_blank"
              class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 hover:border-primary hover:bg-primary hover:text-white"
            >
              <svg
            ...
            <!-- {{-- Twitter --}} -->
            <a
              href="https://twitter.com/muhammadisa226"
              target="_blank"
              class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 hover:border-primary hover:bg-primary hover:text-white"
            >
              <svg
